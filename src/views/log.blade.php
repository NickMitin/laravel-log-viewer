...
<body>
    ...
    $('.table-container button.expand').on('click', function () {
      $('#' + $(this).data('display')).toggle();
    });

	$('.table-container .toggle-block').on('click', function () {
      const block_type = $(this).data('type');
	  const button_id = $(this).data('number');
	  $(this).parents('tr').find('ul[data-type=' + block_type + '][data-number=' + button_id + ']').show();
	  $(this).hide();
    });
